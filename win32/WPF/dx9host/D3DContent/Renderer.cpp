...
HRESULT CRenderer::CheckDeviceState()
{
	if (m_pd3dDeviceEx)
	{
...
HRESULT CRenderer::CreateSurface(UINT uWidth, UINT uHeight, bool fUseAlpha, UINT uNumSamples)
{
	HRESULT hr = S_OK;
	...
	IFC(m_pd3dDevice->CreateRenderTarget(
		...
		static_cast<D3DMULTISAMPLE_TYPE>(uNumSamples),
		0,
