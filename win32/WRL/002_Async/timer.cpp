...
int wmain()
{
	...
	// Create an event that is set after the timer callback completes. We later use this event
	// to wait for the timer to complete.
	// This event is for demonstration only in a console app. In most apps, you typically don't
	...
	// Print a message and wait for the timer callbck to complete.
